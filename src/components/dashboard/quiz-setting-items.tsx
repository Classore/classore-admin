...
export const PassMark = () => {
	...
	return (
		<div className="h-10">
			<Select value={String(bench_mark)} onValueChange={(value) => addValue("bench_mark", value)}>
	...
	return (
		<div className="flex h-10 items-center">
			...
			<div className="flex flex-col gap-1">
				...
				<Select value={String(minute)} onValueChange={(value) => addValue("timer_minute", value)}>
