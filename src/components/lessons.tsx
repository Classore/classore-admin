...
export const Lessons = ({ lessonTab, chapterId }: LessonsProps) => {
	...
	return (
		<TabPanel
			...
			value={lessonTab}>
			<details open>
				<summary className="cursor-pointer p-2">Lesson Details</summary>
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col gap-4">
						<p className="rounded bg-blue-100 p-2 text-center text-xs text-blue-600">
							<strong>Note:</strong> Uploaded video may take a while before being visible. After
							saving this lesson, <br /> refresh the page (after 2mins) to see the uploaded
							video.
						</p>
						{/* UPLOAD VIDEO */}
